...
while(len(board_idx)!=0) and check_win(board)==0: 
    ...
    print_table(board)
    if len(board_idx) != 0 and check_win(board)==0:
        n = len(board_idx)
